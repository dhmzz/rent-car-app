        ...
        <div class="card-header border-0 pt-5">
          <div class="d-flex justify-content-between w-100 flex-wrap gap-3 action_menu">
            <div class="d-flex align-items-center flex-grow-1 action_menu mb-mobile-2"> 
                <label>
                  <span class="text-nowrap me-5">Company Code</span>
                </label>
            ...
            <div class="d-flex align-items-center flex-grow-1 action_menu"> 
                <label>
                  <span class="text-nowrap me-5">Company Name</span>
                </label>
                <div class="flex-grow-1">
        ...
        <div class="card-body mt-3 mx-2">
          <div class="d-flex justify-content-between flex-wrap action_menu">
            <div class="d-flex gap-2 action_menu mb-2">
              <button class="btn btn-light-primary text-nowrap" >
                <KTIcon icon-name="plus" icon-class="fs-3" />
                Add
              </button>
              <button class="btn btn-light-success text-nowrap" disabled>
                <KTIcon icon-name="pencil" icon-class="fs-3"/>
                Edit
              </button>
              <button class="btn btn-light-danger text-nowrap"  disabled>
                <KTIcon icon-name="trash" icon-class="fs-3"/>
                Delete
              </button>
              <button class="btn btn-light-info text-nowrap" >
            ...
            <div class="d-flex gap-2 action_menu mb-2">
              <button class="btn btn-light-success text-nowrap">
                Search
              </button>
              <button class="btn btn-light-secondary text-nowrap">
                Clear
              </button>
            </div>
          </div>
